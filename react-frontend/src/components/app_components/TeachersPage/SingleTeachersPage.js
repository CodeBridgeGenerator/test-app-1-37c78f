...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Years of Experience</label><p className="m-0 ml-3" >{Number(_entity?.yearsOfExperience)}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleTeachersId}
        user={props.user}
        alert={props.alert}
