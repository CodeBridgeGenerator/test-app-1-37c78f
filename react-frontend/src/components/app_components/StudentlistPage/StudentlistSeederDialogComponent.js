...
import seederData from "./studentlist.seeder.json";
...
const StudentlistSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(StudentlistSeederDialogComponent);
